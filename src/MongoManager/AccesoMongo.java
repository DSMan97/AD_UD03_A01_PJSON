...
public class AccesoMongo extends Conexion implements Intercambio {
	 ...
	 * 
	 * private void updateName(String nombre, String oldname) { // M�todo para
	 * modificar el nombre
	 * 
	 ...
	 * e.printStackTrace(); } }
	 * 
	 * private void updateApellido1(String apellido1, String oldname) { // M�todo
	 ...
	 * }
	 * 
	 * private void updateApellido2(String apellido2, String oldname) { // M�todo
	 ...
	 * }
	 * 
	 * private void updateTelefono(int telefono, String oldname) { // M�todo para
	 ...
	 * }
	 * 
	 * private void updateEmail(String email, String oldname) { // M�todo para
	 * modificar el email
	 * 
	 * 
	 * PreparedStatement pstm; try { for (Entry<Integer, Contacto> entry :
